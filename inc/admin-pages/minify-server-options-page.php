            ...
            <div class="card-body pb-4" style="min-height: 60vh">
                ...
                <div class="border rounded mt-1 mb-3 shadow-sm p-3 bg-custom-gray" style="min-height: 53vh">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input change-server-status" name="status_aktiv" type="checkbox"
                               role="switch"
                               id="CheckServerAktiv" <?= ! get_option( 'server_status_aktiv' ) ?: ' checked' ?>>
                        <label class="form-check-label" for="CheckServerAktiv">aktiv</label>
                    </div>
                    <hr>
                    <fieldset class="fieldset-server-option" <?= get_option( 'server_status_aktiv' ) ?: ' disabled' ?>>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-12">
                                    ...
                                    <input type="text" name="memcache_host" value="<?=$stat->memcache_host?>" class="form-control"
                                           id="InputMemHost">
                            </div>
                            <div class="col-xl-4 col-lg-6 col-12">
                                    <label for="InputMemPort" class="form-label">Memcache Port</label>
                                    <input type="number" value="<?=$stat->memcache_port?>" name="memcache_port" class="form-control" id="InputMemPort">
                            </div>
                        </div>
